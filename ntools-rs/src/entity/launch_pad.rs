...
use crate::{collision_util::overlap_circle_vs_circle, ninja::{self, HumanNinja}, orientation::Orientation};
...
impl LaunchPad {
    ...
    pub fn logical_collision(&mut self, ninja: &HumanNinja) -> Option<DVec2> {
