(async () => {
  ...
  const fr = false, gr = (t, e) => t === e, At = Symbol("solid-track"), Ge = {
    equals: gr
  };
  let jt = Bt;
  const fe = 1, Fe = 2, Mt = {
  ...
  var U = null;
  let Xe = null, yr = null, G = null, H = null, ae = null, ze = 0;
  function $e(t, e) {
    const r = G, s = U, o = t.length === 0, i = e === void 0 ? s : e, _ = o ? Mt : {
      owned: null,
      cleanups: null,
  ...
  function b(t, e) {
    ...
    }, s = (o) => (typeof o == "function" && (o = o(r.value)), Ct(r, o));
    return [
      Nt.bind(r),
      s
    ];
  ...
  function Q(t, e, r) {
    ...
    return s.observers = null, s.observerSlots = null, s.comparator = r.equals || void 0, Ne(s), Nt.bind(s);
  }
  function re(t) {
    if (G === null) return t();
    const e = G;
  ...
  function Ct(t, e, r) {
    ...
    return (!t.comparator || !t.comparator(s, e)) && (t.value = e, t.observers && t.observers.length && Ce(() => {
      for (let o = 0; o < t.observers.length; o += 1) {
        ...
        _ && Xe.disposed.has(i), (_ ? !i.tState : !i.state) && (i.pure ? H.push(i) : ae.push(i), i.observers && Ot(i)), _ || (i.state = fe);
      }
  ...
  function br(t, e, r) {
    ...
    try {
      ...
      return t.pure && (t.state = fe, t.owned && t.owned.forEach(je), t.owned = null), t.updatedAt = r + 1, It(_);
    } finally {
      G = i, U = o;
    }
    (!t.updatedAt || t.updatedAt <= r) && (t.updatedAt != null && "observers" in t ? Ct(t, s) : t.value = s, t.updatedAt = r);
  }
  function it(t, e, r, s = fe, o) {
    const i = {
      fn: t,
      state: s,
      updatedAt: null,
    ...
    return U === null || U !== Mt && (U.owned ? U.owned.push(i) : U.owned = [
      i
    ]), i;
  }
  function Ue(t) {
    if (t.state === 0) return;
    if (t.state === Fe) return qe(t);
  ...
  function Ce(t, e) {
    ...
    try {
      ...
      r || (ae = null), H = null, It(s);
    }
  }
  function xr(t) {
    if (H && (Bt(H), H = null), t) return;
    const e = ae;
    ae = null, e.length && Ce(() => jt(e), false);
  }
  function Bt(t) {
  ...
  function qe(t, e) {
    ...
    for (let r = 0; r < t.sources.length; r += 1) {
      ...
      if (s.sources) {
        const o = s.state;
        o === fe ? s !== e && (!s.updatedAt || s.updatedAt < ze) && Ue(s) : o === Fe && qe(s, e);
      }
    }
  }
  function Ot(t) {
    for (let e = 0; e < t.observers.length; e += 1) {
      ...
      r.state || (r.state = Fe, r.pure ? H.push(r) : ae.push(r), r.observers && Ot(r));
    }
  }
  function je(t) {
    let e;
  ...
  function $r(t, e, r = {}) {
    ...
    return ye(() => We(i)), () => {
      ...
      return c[At], re(() => {
        ...
        if (p === 0) _ !== 0 && (We(i), i = [], s = [], o = [], _ = 0, n && (n = [])), r.fallback && (s = [
          st
  ...
  function Sr(t, e, r = {}) {
    ...
    return ye(() => We(i)), () => {
      ...
      return p[At], re(() => {
        if (m === 0) return n !== 0 && (We(i), i = [], s = [], o = [], n = 0, _ = []), r.fallback && (s = [
          st
  ...
  const Rt = (t) => `Stale read from <${t}>.`;
  function _t(t) {
    const e = "fallback" in t && {
      fallback: () => t.fallback
    };
    return Q($r(() => t.each, t.children, e || void 0));
  }
  function z(t) {
    const e = "fallback" in t && {
      fallback: () => t.fallback
    };
    return Q(Sr(() => t.each, t.children, e || void 0));
  }
  function F(t) {
  ...
  function Dr(t) {
    ...
    return Q(() => {
      ...
      return typeof n == "function" && n.length > 0 ? re(() => n(_.keyed ? i() : () => {
        var _a2;
        if (((_a2 = re(r)()) == null ? void 0 : _a2[0]) !== o) throw Rt("Match");
        return i();
      })) : n;
    }, void 0, void 0);
  }
  ...
  function Ve(t, e, r, s, o) {
    ...
    if (t = _ && r[0] && r[0].parentNode || t, i === "string" || i === "number") {
      ...
      if (Array.isArray(e)) {
        ...
        if (ot(n, e, r, o)) return T(() => r = Ve(t, n, r, s, true)), () => r;
        if (n.length === 0) {
          if (r = xe(t, r, s), _) return r;
        } else c ? r.length === 0 ? dt(t, n, s) : Tr(t, r, n) : (r && xe(t), dt(t, n));
        r = n;
      } else if (e.nodeType) {
        if (Array.isArray(r)) {
  ...
  const Ar = "" + new URL("ntools_rs_bg-CER4Jow6.wasm", import.meta.url).href, jr = async (t = {}, e) => {
    let r;
  ...
  let Je = 0;
  function Cr(t, e) {
    return Je += e, Je >= Nr && (Re = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
  ...
  function He(t, e) {
    ...
    return Se().set(t, r / 1), he = t.length, r;
  }
  function Ke(t) {
  ...
  function Or(t, e, r) {
    if (r === void 0) {
      ...
      return Se().subarray(c, c + n.length).set(n), he = n.length, c;
    }
  ...
  function Kt(t) {
    const e = He(t, l.__wbindgen_malloc), r = he;
    l.set_anim_data(e, r);
  }
  function pt() {
  ...
  class De {
    ...
    load_attract(e) {
      const r = He(e, l.__wbindgen_malloc), s = he, o = l.editor_load_attract(this.__wbg_ptr, r, s);
      if (o[1]) throw Ke(o[0]);
    }
    load_map(e) {
      const r = He(e, l.__wbindgen_malloc), s = he, o = l.editor_load_map(this.__wbg_ptr, r, s);
      if (o[1]) throw Ke(o[0]);
    }
    export_map() {
    ...
    get_level_name() {
      ...
      try {
        ...
        return e = s[0], r = s[1], ge(s[0], s[1]);
      } finally {
        l.__wbindgen_free(e, r, 1);
      }
    }
    set_level_name(e) {
      const r = Or(e, l.__wbindgen_malloc, l.__wbindgen_realloc), s = he;
  ...
  class Te {
    ...
    static from_attract(e) {
      const r = He(e, l.__wbindgen_malloc), s = he, o = l.replay_from_attract(r, s);
      if (o[2]) throw Ke(o[1]);
  ...
  const a = await jr({
    "./ntools_rs_bg.js": {
      __wbg_exportedentity_new: Gr,
      __wbg___wbindgen_throw_b855445ff6a94295: Kr,
      __wbindgen_init_externref_table: Ur,
      __wbindgen_cast_2241b6af4c4b2941: Fr
    }
  }, Ar), qr = a.memory, Wr = a.__wbg_editor_free, Vr = a.editor_new, Hr = a.editor_load_attract, Yr = a.editor_load_map, zr = a.editor_export_map, Zr = a.editor_get_level_name, Xr = a.editor_set_level_name, Jr = a.editor_to_replay, Qr = a.editor_mode, es = a.editor_tiles_path, ts = a.editor_selected_tiles_path, rs = a.editor_palette_center_x, ss = a.editor_palette_center_y, os = a.editor_palette_selection_x, ns = a.editor_palette_selection_y, is = a.editor_get_show_trail, _s = a.editor_set_show_trail, ls = a.editor_set_cursor_pos, as = a.editor_cursor_down, cs = a.editor_cursor_up, ds = a.editor_double_click, us = a.editor_tile_crosshair_col, ps = a.editor_tile_crosshair_row, hs = a.editor_crosshair_x, fs = a.editor_crosshair_y, gs = a.editor_entities, ys = a.editor_preview_entities, ws = a.editor_selected_tile_outline_path, ms = a.editor_show_half_grid, bs = a.editor_show_quarter_grid, xs = a.editor_undo, vs = a.editor_redo, ks = a.editor_press_escape, $s = a.editor_press_backtick, Ss = a.editor_press_1, Ds = a.editor_press_2, Ts = a.editor_press_3, Ps = a.editor_press_4, Es = a.editor_press_5, Ls = a.editor_press_6, As = a.editor_press_7, js = a.editor_press_8, Ms = a.editor_press_9, Ns = a.editor_press_0, Cs = a.editor_press_dash, Bs = a.editor_press_equals, Os = a.editor_press_q, Is = a.editor_press_w, Rs = a.editor_press_a, Ks = a.editor_press_s, Gs = a.editor_press_e, Fs = a.editor_press_d, Us = a.editor_press_z, qs = a.editor_press_x, Ws = a.editor_press_c, Vs = a.editor_press_t, Hs = a.editor_press_i, Ys = a.editor_press_o, zs = a.editor_press_p, Zs = a.editor_press_bracket_left, Xs = a.editor_press_bracket_right, Js = a.editor_press_f, Qs = a.editor_press_n, eo = a.editor_press_m, to = a.editor_press_comma, ro = a.editor_press_slash, so = a.editor_press_num_0, oo = a.editor_press_num_3, no = a.editor_press_num_7, io = a.editor_press_up, _o = a.editor_press_down, lo = a.editor_press_left, ao = a.editor_press_right, co = a.editor_press_enter, uo = a.editor_press_space, po = a.editor_press_alt_left, ho = a.editor_press_shift, fo = a.editor_release_q, go = a.editor_release_w, yo = a.editor_release_a, wo = a.editor_release_s, mo = a.editor_release_e, bo = a.editor_release_d, xo = a.editor_release_z, vo = a.editor_release_c, ko = a.editor_release_space, $o = a.editor_release_alt_left, So = a.editor_release_shift, Do = a.editor_receive_past_ninjas, To = a.editor_past_ninjas_len, Po = a.editor_past_ninja_x, Eo = a.editor_past_ninja_y, Lo = a.editor_past_ninja_bones, Ao = a.__wbg_exportedentity_free, jo = a.__wbg_get_exportedentity_type_int, Mo = a.__wbg_set_exportedentity_type_int, No = a.__wbg_get_exportedentity_x, Co = a.__wbg_set_exportedentity_x, Bo = a.__wbg_get_exportedentity_y, Oo = a.__wbg_set_exportedentity_y, Io = a.__wbg_get_exportedentity_deg, Ro = a.__wbg_set_exportedentity_deg, Ko = a.__wbg_get_exportedentity_switch_x, Go = a.__wbg_set_exportedentity_switch_x, Fo = a.__wbg_get_exportedentity_switch_y, Uo = a.__wbg_set_exportedentity_switch_y, qo = a.set_anim_data, Wo = a.get_anim_state, Vo = a.__wbg_replay_free, Ho = a.replay_from_attract, Yo = a.replay_send_past_ninjas, zo = a.replay_set_input, Zo = a.replay_tick, Xo = a.replay_seek, Jo = a.replay_seek_preview, Qo = a.replay_place_ninja, en = a.replay_replay_length, tn = a.replay_progress, rn = a.replay_progress_preview, sn = a.replay_tiles_path, on = a.replay_ninja_x, nn = a.replay_ninja_y, _n = a.replay_ninja_preview_x, ln = a.replay_ninja_preview_y, an = a.replay_ninja_bones, cn = a.replay_ninja_preview_bones, dn = a.replay_mines_len, un = a.replay_mine_x, pn = a.replay_mine_y, hn = a.replay_mine_state, fn = a.replay_bounce_blocks_len, gn = a.replay_bounce_block_x, yn = a.replay_bounce_block_y, wn = a.replay_bounce_block_deg, mn = a.replay_one_ways_len, bn = a.replay_one_way_x, xn = a.replay_one_way_y, vn = a.replay_one_way_deg, kn = a.replay_boost_pads_len, $n = a.replay_boost_pad_x, Sn = a.replay_boost_pad_y, Dn = a.replay_boost_pad_deg, Tn = a.replay_boost_pad_anim_progress, Pn = a.replay_exit_doors_len, En = a.replay_exit_door_x, Ln = a.replay_exit_door_y, An = a.replay_exit_anim_progress, jn = a.replay_exit_switch_x, Mn = a.replay_exit_switch_y, Nn = a.replay_thwumps_len, Cn = a.replay_thwump_x, Bn = a.replay_thwump_y, On = a.replay_thwump_deg, In = a.replay_launch_pads_len, Rn = a.replay_launch_pad_x, Kn = a.replay_launch_pad_y, Gn = a.replay_launch_pad_deg, Fn = a.replay_floor_guards_len, Un = a.replay_floor_guard_x, qn = a.replay_floor_guard_y, Wn = a.replay_floor_guard_deg, Vn = a.replay_locked_doors_len, Hn = a.replay_locked_door_x, Yn = a.replay_locked_door_y, zn = a.replay_locked_door_deg, Zn = a.replay_locked_door_anim_progress, Xn = a.replay_locked_switch_x, Jn = a.replay_locked_switch_y, Qn = a.replay_trap_doors_len, ei = a.replay_trap_door_x, ti = a.replay_trap_door_y, ri = a.replay_trap_door_deg, si = a.replay_trap_door_anim_progress, oi = a.replay_trap_switch_x, ni = a.replay_trap_switch_y, ii = a.replay_regular_doors_len, _i = a.replay_regular_door_x, li = a.replay_regular_door_y, ai = a.replay_regular_door_deg, ci = a.replay_regular_door_anim_progress, di = a.replay_shove_thwumps_len, ui = a.replay_shove_thwump_x, pi = a.replay_shove_thwump_y, hi = a.replay_shove_thwump_deg, fi = a.replay_shove_thwump_touch, gi = a.editor_press_y, yi = a.editor_press_u, wi = a.editor_press_h, mi = a.editor_press_j, bi = a.editor_press_k, xi = a.editor_press_l, vi = a.editor_press_num_1, ki = a.editor_press_num_2, $i = a.editor_press_num_4, Si = a.editor_press_num_5, Di = a.__wbindgen_externrefs, Ti = a.__wbindgen_malloc, Pi = a.__externref_table_dealloc, Ei = a.__wbindgen_free, Li = a.__wbindgen_realloc, Ai = a.__externref_drop_slice, Gt = a.__wbindgen_start, ji = Object.freeze(Object.defineProperty({
    __proto__: null,
    __externref_drop_slice: Ai,
    __externref_table_dealloc: Pi,
    __wbg_editor_free: Wr,
    ...
    __wbindgen_externrefs: Di,
    __wbindgen_free: Ei,
    __wbindgen_malloc: Ti,
    __wbindgen_realloc: Li,
    __wbindgen_start: Gt,
    ...
    editor_press_num_1: vi,
    editor_press_num_2: ki,
    editor_press_num_3: oo,
    editor_press_num_4: $i,
    editor_press_num_5: Si,
    ...
    get_anim_state: Wo,
    memory: qr,
    replay_boost_pad_anim_progress: Tn,
    replay_boost_pad_deg: Dn,
    replay_boost_pad_x: $n,
    replay_boost_pad_y: Sn,
    replay_boost_pads_len: kn,
    replay_bounce_block_deg: wn,
    replay_bounce_block_x: gn,
    replay_bounce_block_y: yn,
    replay_bounce_blocks_len: fn,
    replay_exit_anim_progress: An,
    replay_exit_door_x: En,
    replay_exit_door_y: Ln,
    replay_exit_doors_len: Pn,
    replay_exit_switch_x: jn,
    replay_exit_switch_y: Mn,
    replay_floor_guard_deg: Wn,
    replay_floor_guard_x: Un,
    replay_floor_guard_y: qn,
    replay_floor_guards_len: Fn,
    replay_from_attract: Ho,
    replay_launch_pad_deg: Gn,
    replay_launch_pad_x: Rn,
    replay_launch_pad_y: Kn,
    replay_launch_pads_len: In,
    replay_locked_door_anim_progress: Zn,
    replay_locked_door_deg: zn,
    replay_locked_door_x: Hn,
    replay_locked_door_y: Yn,
    replay_locked_doors_len: Vn,
    replay_locked_switch_x: Xn,
    replay_locked_switch_y: Jn,
    replay_mine_state: hn,
    replay_mine_x: un,
    replay_mine_y: pn,
    replay_mines_len: dn,
    replay_ninja_bones: an,
    replay_ninja_preview_bones: cn,
    replay_ninja_preview_x: _n,
    replay_ninja_preview_y: ln,
    replay_ninja_x: on,
    replay_ninja_y: nn,
    replay_one_way_deg: vn,
    replay_one_way_x: bn,
    replay_one_way_y: xn,
    replay_one_ways_len: mn,
    replay_place_ninja: Qo,
    replay_progress: tn,
    replay_progress_preview: rn,
    replay_regular_door_anim_progress: ci,
    replay_regular_door_deg: ai,
    replay_regular_door_x: _i,
    replay_regular_door_y: li,
    replay_regular_doors_len: ii,
    replay_replay_length: en,
    replay_seek: Xo,
    replay_seek_preview: Jo,
    replay_send_past_ninjas: Yo,
    replay_set_input: zo,
    replay_shove_thwump_deg: hi,
    replay_shove_thwump_touch: fi,
    replay_shove_thwump_x: ui,
    replay_shove_thwump_y: pi,
    replay_shove_thwumps_len: di,
    replay_thwump_deg: On,
    replay_thwump_x: Cn,
    replay_thwump_y: Bn,
    replay_thwumps_len: Nn,
    replay_tick: Zo,
    replay_tiles_path: sn,
    replay_trap_door_anim_progress: si,
    replay_trap_door_deg: ri,
    replay_trap_door_x: ei,
    replay_trap_door_y: ti,
    replay_trap_doors_len: Qn,
    replay_trap_switch_x: oi,
    replay_trap_switch_y: ni,
    set_anim_data: qo
  }, Symbol.toStringTag, {
    value: "Module"
  }));
  Mr(ji);
  Gt();
  function Mi({ x: t, y: e, deg: r }) {
    return `translate(${t},${e}) rotate(${r},0,0)`;
  }
  var Ni = v("<svg><path stroke-linejoin=round stroke-linecap=round stroke-width=1.0909090909090908></svg>", false, true, false);
  const Ci = [
    [
      0,
      12
  ...
  function Ye(t) {
    function e() {
      const r = t.bones();
      return r ? Ci.map(([s, o]) => `M ${20 * r[s]} ${20 * r[s + 13]} ${20 * r[o]} ${20 * r[o + 13]}`).join(" ") : "";
    }
    return (() => {
      var r = Ni();
      return T((s) => {
        var o = t.class, i = Mi(t.ninja()), _ = e();
  ...
  var Bi = v("<svg><g><rect fill=url(#exit-gradient) y=-11 height=23></rect><path fill=var(--exit-panel) stroke=var(--exit-border)></path><path fill=var(--exit-panel) stroke=var(--exit-border)></path><path stroke=var(--exit-border) stroke-width=3 fill=none stroke-linecap=round></path><path stroke=var(--exit-border) stroke-width=3 fill=none stroke-linecap=round></svg>", false, true, false), Oi = v("<svg><linearGradient id=exit-gradient x1=0 x2=0 y1=1 y2=0><stop offset=0% stop-color=var(--open-exit-lower)></stop><stop offset=16% stop-color=var(--open-exit-lower)></stop><stop offset=16% stop-color=var(--open-exit-upper)></stop><stop offset=19% stop-color=var(--open-exit-upper)></stop><stop offset=19% stop-color=var(--open-exit-lower)></stop><stop offset=30% stop-color=var(--open-exit-lower)></stop><stop offset=30% stop-color=var(--open-exit-upper)></stop><stop offset=37% stop-color=var(--open-exit-upper)></stop><stop offset=37% stop-color=var(--open-exit-lower)></stop><stop offset=44% stop-color=var(--open-exit-lower)></stop><stop offset=44% stop-color=var(--open-exit-upper)></stop><stop offset=60% stop-color=var(--open-exit-upper)></stop><stop offset=60% stop-color=var(--open-exit-lower)></stop><stop offset=65% stop-color=var(--open-exit-lower)></stop><stop offset=65% stop-color=var(--open-exit-upper)></stop><stop offset=100% stop-color=var(--open-exit-upper)></svg>", false, true, false);
  function Ii(t, e) {
  ...
  var Ui = v('<svg><g><path d="M 0 0 m -5 -4.5 h 10 l 2 2 v 5 l -2 2 h -10 l -2 -2 v -5 l 2 -2"></path><path stroke=var(--exit-switch-center) fill=none></path><path stroke=var(--exit-switch-center) fill=none></svg>', false, true, false);
  function qi(t, e) {
    return t.x == e.x && t.y == e.y && t.animProgress === e.animProgress;
  }
  function Wi(t) {
  ...
  function Hi(t) {
    return (() => {
      var e = Ui(), r = e.firstChild, s = r.nextSibling, o = s.nextSibling;
      return T((i) => {
        var _ = Wi(t.exitSwitch), n = `var(--exit-switch-background${t.exitSwitch().animProgress > 0 ? "-collected" : ""})`, c = `var(--exit-switch-border${t.exitSwitch().animProgress > 0 ? "-collected" : ""})`, p = `M ${-2 * t.exitSwitch().animProgress} ${-pe} h ${-pe} v ${2 * pe} h ${pe}`, m = `M ${2 * t.exitSwitch().animProgress} ${-pe} h ${pe} v ${2 * pe} h ${-pe}`;
  ...
  var Yi = v("<svg><use href=#one-way></svg>", false, true, false), zi = v("<svg><g id=one-way><line stroke=var(--oneway-long) x1=-0.5 y1=-12 x2=-0.5 y2=12></line><line stroke=var(--oneway-short) x1=-3.5 y1=-9 x2=-3.5 y2=9></svg>", false, true, false);
  function Zi(t, e) {
  ...
  function qt(t) {
    ...
    return u(z, {
      ...
      children: (r) => (() => {
        var s = Yi();
        return T(() => y(s, "transform", Xi(r))), s;
      })()
    });
  }
  function Wt() {
    return (() => {
      var t = zi(), e = t.firstChild;
      return e.nextSibling, t;
    })();
  }
  var Qi = v("<svg><use></svg>", false, true, false), e_ = v("<svg><g id=toggled><line stroke-linecap=round stroke-width=1.3636363636363635 stroke=var(--mine-exterior) x1=-4.090909090909091 y1=0 x2=4.090909090909091 y2=0></line><line stroke-linecap=round stroke-width=1.3636363636363635 stroke=var(--mine-exterior) x1=0 y1=-4.090909090909091 x2=0 y2=4.090909090909091></line><line stroke-linecap=round stroke-width=1.3636363636363635 stroke=var(--mine-exterior) x1=-2.8927095593995125 y1=-2.8927095593995125 x2=2.8927095593995125 y2=2.8927095593995125></line><line stroke-linecap=round stroke-width=1.3636363636363635 stroke=var(--mine-exterior) x1=-2.8927095593995125 y1=2.8927095593995125 x2=2.8927095593995125 y2=-2.8927095593995125></line><circle fill=var(--mine-exterior) r=2.727272727272727></circle><circle fill=var(--mine-interior) r=1.9090909090909092></svg>", false, true, false), t_ = v("<svg><g id=untoggled><circle r=2.727272727272727 stroke-width=1.0909090909090908 stroke=var(--toggle-mine) fill=none></svg>", false, true, false), r_ = v("<svg><g id=toggling><circle r=2.727272727272727 stroke-width=1.0909090909090908 stroke=var(--toggling-mine) fill=none></svg>", false, true, false);
  const s_ = 0, o_ = 1;
  function n_(t, e) {
  ...
  function Ht() {
    return [
      (() => {
        var t = e_(), e = t.firstChild, r = e.nextSibling, s = r.nextSibling, o = s.nextSibling, i = o.nextSibling;
  ...
  var l_ = v("<svg><line class=bar stroke-width=2 x1=-11 y1=0 y2=0></svg>", false, true, false), a_ = v("<svg><line class=bar stroke-width=2 x1=11 y1=0 y2=0></svg>", false, true, false), c_ = v("<svg><g class=regular-door></svg>", false, true, false);
  function d_(t, e) {
  ...
  function g_(t) {
    ...
    return (() => {
      ...
      })), T(() => y(r, "transform", u_(t.regularDoor))), r;
    })();
  }
  var y_ = v("<svg><line class=bar stroke-width=2 x1=-11 y1=0 y2=0></svg>", false, true, false), w_ = v("<svg><line class=bar stroke-width=2 x1=11 y1=0 y2=0></svg>", false, true, false), yt = v("<svg><line class=center stroke-width=4 stroke-linecap=round y1=0 y2=0></svg>", false, true, false), m_ = v("<svg><g class=locked-door></svg>", false, true, false);
  function b_(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg && t.animProgress === e.animProgress;
  }
  function x_(t) {
  ...
  function S_(t) {
    ...
    function s() {
      let o = t.lockedDoor().animProgress;
      return o = Math.min(Math.max((o - 0.4) / 0.6, 0), 1), 0 + ($_ - 0) * o;
    }
    return (() => {
      var o = m_();
      return x(o, u(F, {
      ...
      }), null), T(() => y(o, "transform", x_(t.lockedDoor))), o;
    })();
  }
  var D_ = v("<svg><use></svg>", false, true, false), T_ = v("<svg><g id=locked-switch><rect x=-3.25 y=-3.25 width=6.5 height=6.5></rect><line x1=-1.5 y1=-0.5 x2=1.5 y2=-0.5 stroke-width=1></svg>", false, true, false), P_ = v("<svg><g id=locked-switch-touched><rect x=-3.25 y=-3.25 width=6.5 height=6.5></rect><line x1=-1.5 y1=0.5 x2=1.5 y2=0.5 stroke-width=1></svg>", false, true, false);
  function E_(t, e) {
  ...
  function Zt(t) {
    ...
    return u(z, {
      ...
      children: (r) => (() => {
        var s = D_();
        return T((o) => {
          var i = r().wasTouched ? "#locked-switch-touched" : "#locked-switch", _ = L_(r);
          return i !== o.e && y(s, "href", o.e = i), _ !== o.t && y(s, "transform", o.t = _), o;
        }, {
          e: void 0,
          t: void 0
  ...
  function Xt() {
    return [
      (() => {
        var t = T_(), e = t.firstChild;
        return e.nextSibling, t;
      })(),
      (() => {
        var t = P_(), e = t.firstChild;
        return e.nextSibling, t;
      })()
    ];
  }
  var j_ = v("<svg><line stroke=var(--trap-door-bar) stroke-width=2 y1=0 y2=0></svg>", false, true, false), wt = v("<svg><line stroke=var(--trap-door-center) stroke-width=4 stroke-linecap=round y1=0 y2=0></svg>", false, true, false), M_ = v("<svg><g></svg>", false, true, false);
  function N_(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg && t.animProgress === e.animProgress;
  }
  function C_(t) {
  ...
  function R_(t) {
    ...
    return (() => {
      ...
      })), T(() => y(o, "transform", C_(t.trapDoor))), o;
    })();
  }
  var K_ = v("<svg><use></svg>", false, true, false), G_ = v("<svg><g id=trap-switch><rect fill=var(--trap-switch-background) stroke=var(--trap-switch-border) x=-1.5 y=-1.5 width=3 height=3></svg>", false, true, false), F_ = v("<svg><g id=trap-switch-touched><rect fill=var(--trap-switch-background-collected) x=-1.5 y=-1.5 width=3 height=3></rect><line stroke=var(--trap-switch-border-collected) x1=-1.5 y1=-1.5 x2=1.5 y2=-1.5></line><line stroke=var(--trap-switch-border-collected) x1=-1.5 y1=1.5 x2=1.5 y2=1.5></svg>", false, true, false);
  function U_(t, e) {
    return t.x === e.x && t.y === e.y && t.wasTouched === e.wasTouched;
  }
  function q_(t) {
  ...
  function Qt(t) {
    ...
    return u(z, {
      ...
      children: (r) => (() => {
        var s = K_();
        return T((o) => {
          var i = r().wasTouched ? "#trap-switch-touched" : "#trap-switch", _ = q_(r);
          return i !== o.e && y(s, "href", o.e = i), _ !== o.t && y(s, "transform", o.t = _), o;
        }, {
          e: void 0,
          t: void 0
  ...
  function er() {
    return [
      ...
      (() => {
        var t = F_(), e = t.firstChild, r = e.nextSibling;
        return r.nextSibling, t;
      })()
    ];
  }
  var V_ = v("<svg><g class=launch-pad><rect x=0 y=-7.5 width=1.5 height=15></rect><line stroke-width=1.5 stroke-linecap=round x1=2.25 y1=-4.5 x2=2.25 y2=4.5></svg>", false, true, false);
  function H_(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg;
  }
  function Y_(t) {
  ...
  function Z_(t) {
    return (() => {
      var e = V_(), r = e.firstChild;
      return r.nextSibling, T(() => y(e, "transform", Y_(t.launchPad))), e;
    })();
  }
  var X_ = v('<svg><g><path d="M -6.25 6 V -2.5 L -2.75 -6 H 2.75 L 6.25 -2.5 V 6 H 4.25 l -1.5 -1.5 H -2.75 l -1.5 1.5 Z"></svg>', false, true, false);
  function J_(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg;
  }
  function Q_(t) {
  ...
  function tl(t) {
    return (() => {
      var e = X_();
      return e.firstChild, T(() => y(e, "transform", Q_(t.floorGuard))), e;
    })();
  }
  var rl = v("<svg><use href=#bounceblock></svg>", false, true, false), sl = v('<svg><g id=bounceblock><path id=bounceblockFill d="M -9.818181818181818 -9.818181818181818 L 9.818181818181818 -9.818181818181818 L 9.818181818181818 9.818181818181818 L -9.818181818181818 9.818181818181818 Z"></path><path id=bounceblockStroke d="M -9.272727272727273 5.454545454545454 V 9.272727272727273 H -5.454545454545454 M -2.1818181818181817 9.272727272727273 H 2.1818181818181817 M 5.454545454545454 9.272727272727273 H 9.272727272727273 V 5.454545454545454 M 9.272727272727273 2.1818181818181817 V -2.1818181818181817 M 9.272727272727273 -5.454545454545454 V -9.272727272727273 H 5.454545454545454 M 2.1818181818181817 -9.272727272727273 H -2.1818181818181817 M -5.454545454545454 -9.272727272727273 H -9.272727272727273 V -5.454545454545454 M -9.272727272727273 -2.1818181818181817 V 2.1818181818181817"fill=none stroke-width=1.0909090909090908></svg>', false, true, false);
  function ol(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg;
  }
  function nl(t) {
  ...
  var _l = v("<svg><use href=#boostpad></svg>", false, true, false), ll = v("<svg><g id=boostpad stroke-width=1.25><line stroke-linecap=round x1=5.5 y1=-2.9000000000000004 x2=2.9000000000000004 y2=-5.5></line><line stroke-linecap=round x1=5.5 y1=1.2999999999999998 x2=-1.2999999999999998 y2=-5.5></line><line stroke-linecap=round x1=5.5 y1=5.5 x2=-5.5 y2=-5.5></line><line stroke-linecap=round x1=1.2999999999999998 y1=5.5 x2=-5.5 y2=-1.2999999999999998></line><line stroke-linecap=round x1=-2.9000000000000004 y1=5.5 x2=-5.5 y2=2.9000000000000004></svg>", false, true, false);
  function al(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg && t.animProgress === e.animProgress;
  }
  function cl(t) {
  ...
  function nr(t) {
    ...
    return u(z, {
      ...
      children: (r) => (() => {
        var s = _l();
        return T((o) => {
          var i = `color-mix(in srgb-linear, var(--boost-pad) ${r().animProgress * 100}%, var(--boost-pad-wooshing))`, _ = cl(r);
  ...
  function ir() {
    return (() => {
      var t = ll(), e = t.firstChild, r = e.nextSibling, s = r.nextSibling, o = s.nextSibling;
      return o.nextSibling, t;
    })();
  }
  var ul = v("<svg><use href=#thwump></svg>", false, true, false), pl = v('<svg><g id=thwump><rect stroke-width=2.5 stroke=var(--thwump-border) fill=var(--thwump-border) stroke-linejoin=round x=-9 y=-9 width=18 height=18></rect><path fill=var(--thwump-interior) d="M 9 -8.5 H 1.5 a 2 2 0 0 1 -2 2 H -6.5 V 6.5 H -0.5 a 2 2 0 0 1 2 2 H 9 Z"></path><path fill=var(--thwump-ray) stroke=var(--thwump-ray) stroke-width=0.5 d="M 8.5 -8.5 H 10.25 V 8.5 H 8.5 Z"></svg>', false, true, false);
  function hl(t, e) {
    return t.x == e.x && t.y == e.y && t.deg == e.deg;
  }
  function fl(t) {
  ...
  function _r(t) {
    ...
    return u(z, {
      ...
      children: (r) => (() => {
        var s = ul();
        return T(() => y(s, "transform", fl(r))), s;
      })()
    });
  }
  function lr() {
    return (() => {
      var t = pl(), e = t.firstChild, r = e.nextSibling;
      return r.nextSibling, t;
    })();
  }
  var yl = v("<svg><g class=shove-thwump><rect stroke-linejoin=round stroke-width=2 x=-5.5 y=-5.5 width=11 height=11></svg>", false, true, false), wl = v("<svg><g><line stroke=black x1=0 y1=0 x2=11.5 y2=0></line><line stroke=black stroke-linecap=round x1=11.5 y1=-11.5 x2=11.5 y2=11.5></line><line stroke=black stroke-linecap=round stroke-width=3 x1=11.5 y1=-5.5 x2=11.5 y2=5.5></svg>", false, true, false);
  function ml(t, e) {
  ...
  function vl(t) {
    return (() => {
      ...
      }), r), T(() => y(e, "transform", bl(t.shoveThwump))), e;
    })();
  }
  const cr = dr((t) => {
  ...
  const El = "" + new URL("palette-CZVUb4uS.png", import.meta.url).href, ur = [
    "acid",
    "airline",
    "argon",
    "autumn",
    ...
    for (const e of mt) {
      t[e] = 0;
      for (const r of mt) bt[r] < bt[e] && (t[e] += Ll[r]);
    }
  ...
  let hr;
  async function Ml() {
    const e = await (await fetch(El)).blob(), r = await createImageBitmap(e), s = document.createElement("canvas");
    s.width = r.width, s.height = r.height;
    const o = s.getContext("2d");
    o.drawImage(r, 0, 0), hr = o;
  }
  function Nl(t) {
    const e = hr, r = ur.indexOf(t);
    if (!e || r < 0) return;
    const s = {};
    for (const o of pr) {
      const { file: i, index: _ } = jl[o], n = Al[i] + _, c = e.getImageData(n, r, 1, 1).data, p = `rgb(${c[0]} ${c[1]} ${c[2]})`;
      s[o] = p;
    }
    return s;
  }
  function Cl(t) {
    for (const e of pr) document.body.style.setProperty(e, t[e]);
  }
  var Bl = v('<div style="padding:0 1.2em;color:var(--main-menu-text)"><label style=color:var(--main-menu-selected);cursor:pointer;text-decoration:underline>Import map<input type=file style=display:none></label> | <a href=# download=Untitled style=color:var(--main-menu-selected)>Export map</a> | <label>Show trail <input type=checkbox></label> | Object corners <select><option>square</option><option>rounded</option></select> | <select></select><input type=text style=float:right>'), Ol = v("<option>");
  function Il(t) {
    return (() => {
      var e = Bl(), r = e.firstChild, s = r.firstChild, o = s.nextSibling, i = r.nextSibling, _ = i.nextSibling, n = _.nextSibling, c = n.nextSibling, p = c.firstChild, m = p.nextSibling, h = c.nextSibling, E = h.nextSibling, P = E.firstChild, N = P.nextSibling, C = E.nextSibling, A = C.nextSibling, O = A.nextSibling;
      return o.addEventListener("change", function() {
        ...
        const D = Nl(S.currentTarget.value);
        D && t.setPalette({
      ...
      })())), O.addEventListener("change", () => cr(t.editor)), O.$$input = (S) => {
  ...
  var Rl = v('<svg><rect fill="color-mix(in srgb,var(--background) 18%,white 15%)"width=150 height=150 style=mix-blend-mode:hard-light></svg>', false, true, false), Kl = v("<svg><circle fill=none stroke=var(--entity-palette-reticle) r=16></svg>", false, true, false), Gl = v('<svg><path d="M -13 -13 V -62 H 13 V -13 H 62 V 13 H 13 V 62 H -13 V 13 H -62 V -13 H -13 M -12 -12 H 12 V 12 H -12 V -12"fill-rule=evenodd fill="color-mix(in srgb,var(--background) 18%,white 15%)"style=mix-blend-mode:hard-light></svg>', false, true, false), Fl = v("<svg><rect fill=none stroke=var(--editor-crosshair) stroke-width=2 width=26 height=26></svg>", false, true, false), Ul = v("<svg><use href=#tilemode-crosshair></svg>", false, true, false), ql = v("<svg><use href=#crosshair></svg>", false, true, false), Wl = v("<svg><polyline stroke=var(--ninja) fill=none></svg>", false, true, false), Vl = v('<svg viewBox="0 0 1056 600"><defs><clipPath id=tiles-clip><use href=#tiles></use></clipPath><path id=tilemode-crosshair stroke-width=1.5 fill=none d="M -13.5 -9 V -13.5 H -9 M 9 -13.5 H 13.5 V -9 M 13.5 9 V 13.5 H 9 M -9 13.5 H -13.5 V 9"></path><path id=crosshair stroke-width=1.5 fill=none d="M -4 0 H 4 M 0 -4 V 4"></path><filter id=outline filterUnits=userSpaceOnUse x=0 y=0 width=1056 height=600><feMorphology in=SourceAlpha operator=dilate radius=0.75 result=DILATED></feMorphology><feFlood flood-color=var(--editor-crosshair) flood-opacity=1 result=COLOR></feFlood><feComposite in=COLOR in2=DILATED operator=in result=OUTLINE></feComposite><feMerge><feMergeNode in=OUTLINE></feMergeNode><feMergeNode in=SourceGraphic></feMergeNode></feMerge></filter><filter id=hollow><feMorphology in=SourceAlpha operator=dilate radius=3 result=DILATED></feMorphology><feComposite operator=out in=DILATED in2=SourceGraphic></feComposite></filter></defs><path id=tiles stroke-width=2 clip-path=url(#tiles-clip) clip-rule=evenodd fill-rule=evenodd></path><g></g><path id=selected-tiles fill-rule=evenodd></path><g><path stroke=var(--editor-crosshair) stroke-width=2 fill=none>'), xt = v("<svg><line class=fine-grid y1=24 y2=576></svg>", false, true, false), vt = v("<svg><line class=fine-grid x1=24 x2=1032></svg>", false, true, false), Hl = v("<svg><line class=regular-grid y1=24 y2=576></svg>", false, true, false), Yl = v("<svg><line class=regular-grid x1=24 x2=1032></svg>", false, true, false), zl = v("<svg><line class=door-switch-line></svg>", false, true, false);
  const Qe = 42, et = 23, kt = 0, $t = 1, Zl = 3, St = 5, Xl = 6, Dt = 7, Jl = 8, tt = 9, Ql = 0, ea = 1, ta = 3, ra = 5, sa = 6, oa = 8, na = 10, ia = 11, _a = 16, la = 17, aa = 20, ca = 21, da = 24, ua = 28, pa = new Float64Array([
    -0.039,
    -0.0249,
    0.1127,
    -0.1738,
  ...
  function Pt() {
    const [t, e] = b([]), [r, s] = b([]), [o, i] = b([]), [_, n] = b([]), [c, p] = b([]), [m, h] = b([]), [E, P] = b([]), [N, C] = b([]), [A, O] = b([]), [S, D] = b([]), [k, M] = b([]), [Z, q] = b([]), [se, ce] = b([]), [ee, oe] = b([]), [_e, de] = b([]), [j, Y] = b([]);
    return {
      ninjas: t,
      setNinjas: e,
      mines: r,
  ...
  function Et(t, e, r, s) {
    ...
    for (const k of r) {
      ...
      k.type_int === Ql ? o.push(M) : k.type_int === ea ? i.push({
        ...M,
        type: s_
      }) : k.type_int === ca ? i.push({
        ...M,
        type: o_
      }) : k.type_int === ta ? (_.push(M), Number.isNaN(k.switch_x) || (n.push(Z), e.push(q))) : k.type_int === ra ? c.push(M) : k.type_int === sa ? (p.push(M), Number.isNaN(k.switch_x) || (m.push(Z), e.push(q))) : k.type_int === oa ? (h.push({
        ...M,
        animProgress: s ? 1 : -1
      }), Number.isNaN(k.switch_x) || (E.push(Z), e.push(q))) : k.type_int === na ? P.push(M) : k.type_int === ia ? N.push(M) : k.type_int === _a ? C.push(M) : k.type_int === la ? A.push(M) : k.type_int === aa ? O.push(M) : k.type_int === da ? S.push({
        ...M,
        animProgress: 1
      }) : k.type_int === ua && D.push({
        ...M,
        touch: 16
      }), k.free();
    }
  ...
  function fa(t) {
    const { editor: e, pastNinjas: r } = t, [s, o] = b(""), [i, _] = b(""), [n, c] = b(true), [p, m] = b(false), [h, E] = b(kt), [P, N] = b({
      row: 1,
      col: 1
    }), [C, A] = b({
      x: 24,
      ...
      x: NaN,
      y: NaN
    }), q = Pt(), se = Pt(), [ce, ee] = b([]), [oe, _e] = b(e.get_show_trail()), [de, j] = b(), Y = (d) => {
      let f = false;
    ...
    document.addEventListener("keydown", Y), document.addEventListener("keyup", X), ye(() => {
    ...
    function W(d) {
      ...
      const f = [];
      Et(q, f, e.entities(), false), Et(se, f, e.preview_entities(), true), ee(f), S(e.selected_tile_outline_path()), k({
        x: e.palette_center_x(),
        y: e.palette_center_y()
      }), Z({
        x: e.palette_selection_x(),
        y: e.palette_selection_y()
      }), j(e.past_ninja_bones()), d && cr(e);
    }
    const ne = [];
    for (let d = 0; d < Qe - 1; d++) ne.push(48 + 24 * d);
    const ue = [];
    for (let d = 0; d < et - 1; d++) ue.push(48 + 24 * d);
    const we = [];
    for (let d = 0; d < Qe; d++) we.push(36 + 24 * d);
    const Pe = [];
    ...
    return W(false), [
      (() => {
        var d = Vl(), f = d.firstChild, me = f.firstChild, te = me.nextSibling;
        te.nextSibling;
        var ie = f.nextSibling, le = ie.nextSibling, $ = le.nextSibling, I = $.nextSibling, R = I.firstChild;
        return d.$$contextmenu = (g) => {
        ...
        }, x(f, u(Ht, {}), te), x(f, u(Wt, {}), te), x(f, u(or, {}), te), x(f, u(Xt, {}), te), x(f, u(er, {}), te), x(f, u(ir, {}), te), x(f, u(lr, {}), te), x(d, u(F, {
          get when() {
            return p();
          },
          get children() {
          ...
          return w !== g.e && y(ie, "d", g.e = w), L !== g.t && y(le, "filter", g.t = L), B !== g.a && y($, "d", g.a = B), J !== g.o && y(R, "d", g.o = J), g;
        }, {
          e: void 0,
          t: void 0,
          a: void 0,
  ...
  var ga = v("<div id=media-controls><div class=text-button><div></div></div><div class=scrubber><div class=track></div><div class=progress></div><div class=previewProgress></div><div class=thumb>");
  function ya(t) {
    const e = () => {
    ...
    let s;
    document.addEventListener("mousemove", i), ye(() => document.removeEventListener("mousemove", i)), document.addEventListener("mouseup", _), ye(() => document.removeEventListener("mouseup", _));
    function o(n) {
      if (s) {
    ...
    return (() => {
      var n = ga(), c = n.firstChild, p = c.firstChild, m = c.nextSibling, h = m.firstChild, E = h.nextSibling, P = E.nextSibling, N = P.nextSibling;
      c.$$click = () => {
      ...
      var C = s;
      return typeof C == "function" ? Er(C, m) : s = m, T((A) => {
  ...
  var wa = v('<svg viewBox="0 0 1056 600"><defs><clipPath id=tiles-clip><use href=#tiles></use></clipPath></defs><path id=tiles stroke-width=2 clip-path=url(#tiles-clip) clip-rule=evenodd fill-rule=evenodd>'), ma = v("<div>");
  function ba(t) {
    const e = t.replay, [r, s] = b(true), [o, i] = b(true), [_, n] = b(void 0), [c, p] = b(0), [m, h] = b(0), [E, P] = b(void 0), N = ($) => {
      $.code === "Enter" ? (e.place_ninja(t.globalEventState.mouseGamePos().x, t.globalEventState.mouseGamePos().y), o() || le(1)) : $.code === "Escape" && (o() ? (i(false), s(false)) : (i(true), s(true)));
    };
    document.addEventListener("keydown", N), ye(() => {
    ...
    const C = () => e.tiles_path(), [A, O] = b({
      ...
      y: -50,
      deg: 0
    }), [k, M] = b(), [Z, q] = b(), se = b([]), ce = b([]), ee = b([]), oe = b([]), _e = b([]), de = b([]), j = b([]), Y = b([]), X = b([]), W = b([]), ne = b([]), ue = b([]), we = b([]), Pe = b([]), Ee = b([]);
    ...
    function le($) {
      O({
        ...
        y: e.ninja_preview_y($),
        deg: 0
      }), M(e.ninja_bones($)), E() === void 0 ? q(void 0) : q(e.ninja_preview_bones($)), __(se, e), il(ce, e, $), Ji(ee, e), dl(oe, e, $), gl(_e, e, $), z_(de, e), el(j, e, $), v_(Y, e, $), A_(X, e), B_(W, e, $), W_(ne, e), p_(ue, e, $), xl(we, e, $), Ki(Pe, e, $), Vi(Ee, e, $), p(e.replay_length());
    }
    return [
      (() => {
        var $ = wa(), I = $.firstChild;
        ...
        }, x(I, u(Ht, {}), null), x(I, u(or, {}), null), x(I, u(Wt, {}), null), x(I, u(Xt, {}), null), x(I, u(er, {}), null), x(I, u(ir, {}), null), x(I, u(lr, {}), null), x(I, u(Fi, {}), null), x($, u(Ft, {
          exitDoors: Pe
        }), R), x($, u(qt, {
          oneWays: ee
        }), R), x($, u(Vt, {
        ...
        return x($, u(F, {
          ...
          get children() {
            return u(ya, {
              ...
              previewSeek: (I) => {
                P(I), e && (I !== void 0 && _() === void 0 && e.seek_preview(I), le(1));
              }
            });
          }
        })), $;
  ...
  function ka() {
    ...
    kl(t), o(t.get_level_name()), document.addEventListener("keydown", (j) => {
    ...
    const q = 0, se = 1, ce = 2, [ee, oe] = b(pt() == q ? q : ce);
    Ml();
    const [_e, de] = b(Pl());
    return wr(() => {
      const j = _e();
      ...
      u(F, {
        ...
        get children() {
          var j = va(), Y = j.firstChild, X = Y.nextSibling;
            ...
            if (W && W.length > 0) {
              ...
              ne.onloadend = () => {
                if (ne.result instanceof ArrayBuffer) {
                  const ue = new Uint8Array(ne.result);
                  try {
                    $l(ue), Kt(ue), oe(pt());
                  } catch {
                    oe(se);
