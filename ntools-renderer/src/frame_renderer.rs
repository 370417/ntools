...
use crate::{dimensions::Dimensions, entity_renderer::{EntityRenderer, SpriteSize}, palette::{ColorTheme, Palette, to_color, to_paint}, tileset_renderer::TilesetRenderer};
...
impl FrameRenderer {
    pub fn new(sprite_size: SpriteSize, replay: &Replay, palette: &Palette, theme: ColorTheme, dims: &Dimensions) -> Self {
        Self {
